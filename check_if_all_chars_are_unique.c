...
int main(void)
{
    ...
    char string1[] = "Ahmed";
    char string2[] = "mahmoud";

    // Test the first function
    if (all_unique(string1))
    {
        printf("All characters in string1 are unique.\n");
    }
    else
    {
        printf("All characters in string1 are NOT unique.\n");
    }

    if (all_unique(string2))
    {
        printf("All characters in string2 are unique.\n");
    }
    else
    {
        printf("All characters in string2 are NOT unique.\n");
    }
